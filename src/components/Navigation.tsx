    ...
    <>
      ...
      <div className="flex items-center px-4 sm:px-6 py-4 mt-16 mb-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 max-w-xs w-auto ml-auto pr-2">
          ...
          <a 
            href="/create-legacy" 
            className="bg-emotional hover:bg-emotional/90 text-white px-4 sm:px-6 py-2 rounded-full font-medium transition-colors text-sm sm:text-base w-full sm:w-auto"
          >
            Create Legacy
          </a>
        </div>
